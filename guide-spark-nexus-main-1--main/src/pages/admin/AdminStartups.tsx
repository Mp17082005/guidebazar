...
// Renamed the main component from 'Startups' to 'AdminStartups'
const AdminStartups = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div
          className="absolute bottom-1/3 right-1/4 w-96 h-96 bg-brand-pink/20 rounded-full blur-3xl opacity-30 animate-pulse"
...
// Changed export default from Startups to AdminStartups
