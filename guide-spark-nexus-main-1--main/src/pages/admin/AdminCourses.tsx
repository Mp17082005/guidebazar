...
// Renamed the main component from 'Courses' to 'AdminCourses'
const AdminCourses = () => {
  // Determine the base path for navigation based on user role
  // This is a placeholder, as the actual base path is determined in Navbar/App.tsx
  // But for consistency in internal links within this component, we can define it.
  // For admin pages, links should generally be relative or explicitly start with /admin
  const basePath = "/admin"; // Explicitly set for admin context
          ...
          >
            ...
            <Card className="bg-gradient-to-br from-brand-purple/10 to-brand-pink/10 border-brand-purple/20 hover:border-brand-purple/40 transition-all duration-300">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-white/70">
                  Premium courses with comprehensive content, certifications,
                  and expert support
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center">
                ...
                {/* Updated Link path for admin context */}
                <Link to={`${basePath}/paid-courses`}>
            ...
            <Card className="bg-gradient-to-br from-green-500/10 to-blue-500/10 border-green-500/20 hover:border-green-500/40 transition-all duration-300">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-white/70">
                  Access quality education at no cost with our free course
                  offerings
                </CardDescription>
              </CardHeader>
              <CardContent className="text-center">
...
// Changed export default from Courses to AdminCourses
