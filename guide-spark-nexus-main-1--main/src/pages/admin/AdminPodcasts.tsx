...
// Renamed the main component from 'Podcasts' to 'AdminPodcasts'
const AdminPodcasts = () => {
                ...
                <Card className="glass-card border-none overflow-hidden group cursor-pointer">
                  <div className="relative">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-3">
                      <Button
                        size="sm"
                        className="bg-white text-purple-600 hover:bg-white/90 mr-2"
                      >
...
// Changed export default from Podcasts to AdminPodcasts
