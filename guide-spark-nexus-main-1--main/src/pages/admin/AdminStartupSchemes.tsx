...
const schemes = [
  {
    ...
    description:
      "Government initiative to promote entrepreneurship and innovation in India.",
  },
  {
    id: 2,
    ...
    description:
      "Government's flagship initiative to promote innovation and entrepreneurship.",
  },
  {
    id: 3,
    ...
    description:
      "Private venture capital fund focusing on early-stage tech startups.",
  },
  {
    id: 4,
...
// Renamed the main component from 'StartupSchemes' to 'AdminStartupSchemes'
const AdminStartupSchemes = () => {
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Explore government and private schemes designed to support student
...
// Changed export default from StartupSchemes to AdminStartupSchemes
export default AdminStartupSchemes;
