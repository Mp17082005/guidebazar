...
// Renamed the main component from 'CourseMaterials' to 'AdminCourseMaterials'
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-white/80 max-w-2xl mx-auto">
              Access curated study materials, notes, and resources for various
...
// Changed export default from CourseMaterials to AdminCourseMaterials
