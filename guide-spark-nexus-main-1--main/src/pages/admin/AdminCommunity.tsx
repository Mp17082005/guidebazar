...
// The posts data does NOT need to be renamed for now, as it's internal content.
const posts = [
  {
    id: 1,
    author: "Meera Kapoor",
    ...
    timeAgo: "2 hours ago",
    content:
      "Just completed my first investment through SIP! Any tips for a beginner? Looking for safe mutual funds with moderate returns.",
    likes: 24,
    comments: 18,
    category: "Finance",
  },
  {
    ...
    timeAgo: "1 day ago",
    content:
      "I'm working on a new AI project for my college's tech fest. Looking for team members with experience in Python and machine learning. DM if interested!",
    likes: 45,
    comments: 32,
    category: "Startups",
  },
  {
    ...
    timeAgo: "3 days ago",
    content:
      "Nervous about my upcoming job interviews. Any resources for tech interview preparation specifically for freshers? Would appreciate any advice from recent graduates.",
    likes: 36,
    comments: 27,
  ...
  },
  {
    ...
    timeAgo: "1 week ago",
    content:
      "I've been practicing meditation for the past month and it's significantly improved my focus during exam preparation. Anyone else experienced similar benefits?",
    likes: 89,
    comments: 41,
...
// Renamed the main component from 'Community' to 'AdminCommunity'
const AdminCommunity = () => {
  ...
  // The 'posts' array is defined outside, so it doesn't need renaming here.
  // The 'sortedPosts' (implicitly used in TabsContent) and 'getAuthorTypeColor'
  // are internal functions/variables, so they also don't need renaming.
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-white/80 mb-10">
              Connect with fellow students, share ideas, and get advice from the
              community.
            </p>
          </motion.div>
              ...
              >
                <Tabs defaultValue="popular" className="mb-6">
                  ...
                  <TabsContent value="unanswered">
                    <PostList
                      posts={posts.filter((post) => post.comments < 5)}
                      activePost={activePost}
                      setActivePost={setActivePost}
                    />
                  </TabsContent>
...
// The PostList component is a sub-component, its name does not need to change.
...
// Renamed the export default from 'Community' to 'AdminCommunity'
