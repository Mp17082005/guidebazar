...
const allShorts = [
  ...
  },
  {
    ...
    thumbnail: "https://images.unspxlash.com/photo-1579621970795-87facc2f976d",
    views: "89K",
...
// Renamed the main component from 'YouTubeShorts' to 'AdminYouTubeShorts'
const AdminYouTubeShorts = () => {
...
// Changed export default from YouTubeShorts to AdminYouTubeShorts
export default AdminYouTubeShorts;
