...
const studentDiscounts = [
  ...
  },
  {
    ...
    instructions:
      "Apply for GitHub Student Developer Pack with student verification",
    link: "https://education.github.com/pack",
    verified: "2024-01-28",
    upvotes: 167,
    image: "💻",
  ...
  },
  {
    ...
    instructions:
      "Verify through StudentBeans and get 50% off annual subscription",
  ...
  },
  {
    ...
    instructions:
      "Verify your student status and get discounted premium access",
...
const StudentDiscounts = () => {
  ...
  const [selectedDiscount, setSelectedDiscount] = useState<
    (typeof studentDiscounts)[0] | null
  >(null);
  ...
  return (
    ...
    <div className="container mx-auto px-4 py-8">
      {" "}
      {/* Keep container and horizontal padding, adjust vertical padding */}
      {/* Enhanced Animated Background (moved to UserLayout if fixed, or adjusted if scrolling) */}
        ...
        >
          ...
          >
            ...
            <motion.h1
              ...
              style={{
                background:
                  "linear-gradient(90deg, #ffffff, #8E44AD, #F06292, #ffffff)",
          ...
          >
            Unlock exclusive deals and save money on tools, apps, and services
            that support your academic journey
          </motion.p>
          ...
          >
            ...
            <Badge className="bg-brand-pink/20 text-brand-pink border-brand-pink/30 px-4 py-2">
              ...
              {studentDiscounts.reduce(
                (sum, discount) => sum + discount.upvotes,
                0
              )}
              + Students Helped
            </Badge>
              ...
              >
                {verificationTypes.map((type) => (
                  <motion.div
                    ...
                    initial="inactive"
                    animate={
                      selectedVerification === type ? "active" : "inactive"
                    }
                    whileHover="hover"
                    whileTap={{ scale: 0.95 }}
                  >
                    <Button
                      variant={
                        selectedVerification === type ? "default" : "outline"
                      }
                      size="sm"
        ...
        >
          <p className="text-white/60 text-lg">
            ...
            <span className="text-brand-purple font-semibold">
              {filteredAndSortedDiscounts.length}
            </span>{" "}
            verified student{" "}
            {filteredAndSortedDiscounts.length === 1 ? "discount" : "discounts"}
          </p>
        </motion.div>
                ...
                <Card className="bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-sm border-white/10 hover:border-brand-purple/30 transition-all duration-500 h-full group cursor-pointer relative overflow-hidden">
                  ...
                  <CardContent className="space-y-4 relative z-10">
                    <div className="flex items-center justify-between">
                      <Badge
                        variant="outline"
                        className="border-green-400/30 text-green-300 bg-green-400/10"
                      >
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center gap-2 text-sm text-white/60">
                        ...
                        <span>
                          Verified{" "}
                          {new Date(discount.verified).toLocaleDateString()}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {discount.tags.map((tag, tagIndex) => (
                        ...
                        >
                          <Badge
                            variant="secondary"
                            className="text-xs bg-white/5 text-white/60 hover:bg-brand-purple/20 hover:text-brand-purple transition-all duration-300"
                          >
                            {tag}
                          </Badge>
                        </motion.div>
                      ...
                      <Dialog>
                        ...
                        <DialogContent className="bg-black/95 border-white/20 text-white backdrop-blur-xl">
                          ...
                          <div className="space-y-4">
                            <div>
                              <h4 className="font-semibold mb-2 text-brand-purple">
                                Eligibility:
                              </h4>
                            ...
                            <div>
                              <h4 className="font-semibold mb-2 text-brand-pink">
                                How to Claim:
                              </h4>
                              <p className="text-white/80">
        ...
        {filteredAndSortedDiscounts.length === 0 && (
          ...
          >
            ...
            <p className="text-white/60 mb-6 text-lg">
              Try adjusting your search or filters to discover more deals
            </p>
