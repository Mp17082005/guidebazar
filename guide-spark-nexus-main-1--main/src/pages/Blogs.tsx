...
//     views: 1800,
//     isPopular: true,
//     excerpt: "Cut down your software costs with these student-friendly tools...",
...
//     fullContent: "https://zerodha.com/varsity/module/introduction-to-stock-markets/"
//   },
//   {
//     id: 4,
...
//     fullContent: "https://www.northeastern.edu/graduate/blog/time-management-tips/"
//   },
//   {
//     id: 5,
...
//                     <Button className="bg-gradient-to-r from-brand-purple to-brand-pink hover:opacity-90" onClick={() => setSelectedBlog(blog)}>
//                       Read More
//                     </Button>
//                   </div>
//                 </CardContent>
...
//             <button onClick={() => setSelectedBlog(null)} className="absolute top-3 right-3">
//               <X className="h-6 w-6" />
//             </button>
...
const Blogs = () => {
  ...
  const getAuthorTypeColor = (type: string) => {
    // Added type annotation for 'type' parameter
    switch (type) {
      case "Student":
        return "bg-blue-500/20 text-blue-400";
      case "Founder":
      ...
      case "Entrepreneurship":
        return "bg-pink-500/20 text-pink-400";
      case "Marketing": // Added Marketing
        return "bg-teal-500/20 text-teal-400";
      case "Poets": // Added Poets
        return "bg-indigo-500/20 text-indigo-400";
      case "health": // Added health
  ...
  return (
    ...
    >
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-white/80 max-w-2xl mx-auto">
          Discover insights, tips, and stories from students, entrepreneurs, and
          industry experts.
        </p>
      </div>
